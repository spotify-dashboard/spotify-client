        ...
        return (
            <div className={styles.parentContainer}>
                ...
                <div className="flex flex-justify-center">
                    <p><span>acousticness</span> - measure of how acoustic the tracks are</p>
                    <p><span>danceability</span> - describes how suitable a track is for dancing based on a combination of musical elements including tempo, rhythm stability, beat strength, and overall regularity</p>
                    <p><span>energy</span> - represents a perceptual measure of intensity and activity (energetic tracks feel fast, loud, and noisy)</p>
                </div>
                <div className="flex flex-vertical-align">    
                    <div className={styles.left}>
                        <p><span>instrumentalness</span> - predicts whether a track contains no vocals</p>
                        <br />
                        <p><span>liveness</span> - detects the presence of an audience in the recording (live performance)</p>
                        <br />
                        <p><span>speechiness</span> - detects the presence of spoken words in a track (talk show, audio book, etc.)</p>
                    </div>
                    <canvas
                        ref="featuresRadar"
